...
interface HieuChuanNhomDongHoNuocManagementProps {
    className?: string,
    isAuthorizing?: boolean,
    setSelectedGroupId?: React.Dispatch<React.SetStateAction<string | null>>;
}

export default function HieuChuanNhomDongHoNuocManagement({ className, isAuthorizing, setSelectedGroupId }: HieuChuanNhomDongHoNuocManagementProps) {
